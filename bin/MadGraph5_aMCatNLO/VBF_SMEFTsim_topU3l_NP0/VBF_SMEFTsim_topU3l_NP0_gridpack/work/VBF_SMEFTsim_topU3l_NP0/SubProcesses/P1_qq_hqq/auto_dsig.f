...
C     
C     Process: u u > h u u NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c > h c c NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u d > h u d NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u u~ > h u u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c~ > h c c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u u~ > h d d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c~ > h s s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u d~ > h u d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c s~ > h c s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d > h d d NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s > h s s NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: b b > h b b NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d u~ > h d u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s c~ > h s c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d~ > h u u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s~ > h c c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d~ > h d d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s~ > h s s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: b b~ > h b b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s c > h s c NP=0 QCD=0 QED<=4 $ w+ w- z @1
...
C     Process: b~ b~ > h b~ b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s~ c~ > h s~ c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u s > h u s NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u b > h u b NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c b > h c b NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u s > h d c NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d c > h u s NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u c > h u c NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u u~ > h s s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u u~ > h b b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c~ > h d d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c~ > h b b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u u~ > h c c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c~ > h u u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u d~ > h c s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c s~ > h u d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u s~ > h u s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u b~ > h u b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c d~ > h c d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c b~ > h c b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u c~ > h u c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c u~ > h c u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u c~ > h d s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d s~ > h u c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s d~ > h c u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c u~ > h s d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d s > h d s NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d b > h d b NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s b > h s b NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d c > h d c NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d u~ > h s c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s c~ > h d u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d~ > h s s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d~ > h b b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s~ > h d d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s~ > h b b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: b b~ > h d d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: b b~ > h s s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d~ > h c c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s~ > h u u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: b b~ > h u u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: b b~ > h c c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d s~ > h d s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d b~ > h d b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s d~ > h s d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s b~ > h s b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: b d~ > h b d~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: b s~ > h b s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: d c~ > h d c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: s u~ > h s u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: b u~ > h b u~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: b c~ > h b c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u~ s~ > h u~ s~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u~ b~ > h u~ b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: c~ b~ > h c~ b~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
C     Process: u~ s~ > h d~ c~ NP=0 QCD=0 QED<=4 $ w+ w- z @1
...
C       Output weights and number of events
        ...
        IF (SUMPROB.NE.0D0)THEN
          DO J=1,SYMCONF(0)
            WRITE(*,'(70E12.4)')((SUMWGT(K,I,J)/SUMPROB,K=1,2),I=1
     $       ,MAXSPROC)
          ENDDO
        ENDIF
        SUMPROB=0D0
        ...
        IF (SUMPROB.NE.0D0)THEN
          DO J=1,SYMCONF(0)
            WRITE(*,'(70E12.4)')((NUMEVTS(K,I,J)/SUMPROB,K=1,2),I=1
     $       ,MAXSPROC)
          ENDDO
        ENDIF
        WRITE(*,*)'Events:'
        DO J=1,SYMCONF(0)
          WRITE(*,'(70I12)')((NUMEVTS(K,I,J),K=1,2),I=1,MAXSPROC)
        ENDDO
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! u u~ > h d d~
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u d~ > h u d~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! d d > h d d
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! d u~ > h d u~
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! d d~ > h u u~
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! d d~ > h d d~
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! s c > h s c
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! u~ u~ > h u~ u~
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! u~ d~ > h u~ d~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! d~ d~ > h d~ d~
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! s~ c~ > h s~ c~
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! u s > h u s
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! u s > h d c
        IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! u c > h u c
        IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! u u~ > h s s~
        IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! u u~ > h c c~
        IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! u d~ > h c s~
        IF(IPROC.EQ.21) DSIGPROC=DSIG21(P1,WGT,IMODE)  ! u s~ > h u s~
        IF(IPROC.EQ.22) DSIGPROC=DSIG22(P1,WGT,IMODE)  ! u c~ > h u c~
        IF(IPROC.EQ.23) DSIGPROC=DSIG23(P1,WGT,IMODE)  ! u c~ > h d s~
        IF(IPROC.EQ.24) DSIGPROC=DSIG24(P1,WGT,IMODE)  ! d s > h d s
        IF(IPROC.EQ.25) DSIGPROC=DSIG25(P1,WGT,IMODE)  ! d c > h d c
        IF(IPROC.EQ.26) DSIGPROC=DSIG26(P1,WGT,IMODE)  ! d u~ > h s c~
        IF(IPROC.EQ.27) DSIGPROC=DSIG27(P1,WGT,IMODE)  ! d d~ > h s s~
        IF(IPROC.EQ.28) DSIGPROC=DSIG28(P1,WGT,IMODE)  ! d d~ > h c c~
        IF(IPROC.EQ.29) DSIGPROC=DSIG29(P1,WGT,IMODE)  ! d s~ > h d s~
        IF(IPROC.EQ.30) DSIGPROC=DSIG30(P1,WGT,IMODE)  ! d c~ > h d c~
        IF(IPROC.EQ.31) DSIGPROC=DSIG31(P1,WGT,IMODE)  ! u~ s~ > h u~ s~
        IF(IPROC.EQ.32) DSIGPROC=DSIG32(P1,WGT,IMODE)  ! u~ s~ > h d~ c~
        IF(IPROC.EQ.33) DSIGPROC=DSIG33(P1,WGT,IMODE)  ! u~ c~ > h u~ c~
        IF(IPROC.EQ.34) DSIGPROC=DSIG34(P1,WGT,IMODE)  ! d~ s~ > h d~ s~
        IF(IPROC.EQ.35) DSIGPROC=DSIG35(P1,WGT,IMODE)  ! d~ c~ > h d~ c~
      ENDIF
