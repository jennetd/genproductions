...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
        IF(MDL_WW1.NE.0D0) FK_MDL_WW1 = SIGN(MAX(ABS(MDL_WW1),
     $    ABS(MDL_MW1*SMALL_WIDTH_TREATMENT)), MDL_WW1)
     ...
     $    ABS(MDL_MZ1*SMALL_WIDTH_TREATMENT)), MDL_WZ1)
      ...
      CALL FFV3_3(W(1,1),W(1,2),GC_202,MDL_MW, FK_MDL_WW,W(1,6))
      CALL FFV3_3(W(1,5),W(1,4),GC_202,MDL_MW, FK_MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVS3_0(W(1,6),W(1,7),W(1,3),GC_391,AMP(1))
      CALL FFV3PW1_3(W(1,5),W(1,4),GC_251,MDL_MW1, FK_MDL_WW1,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL VVS3_0(W(1,6),W(1,8),W(1,3),GC_396,AMP(2))
      CALL FFV3PW1_3(W(1,1),W(1,2),GC_251,MDL_MW1, FK_MDL_WW1,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL VVS3_0(W(1,6),W(1,7),W(1,3),GC_396,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVS3_0(W(1,6),W(1,8),W(1,3),GC_398,AMP(4))
      CALL FFV1_3_3(W(1,1),W(1,4),GC_264,GC_203,MDL_MZ, ZERO,W(1,6))
      CALL FFV1_3_3(W(1,5),W(1,2),GC_263,-GC_203,MDL_MZ, ZERO,W(1,8))
C     Amplitude(s) for diagram number 5
      CALL VVS3_0(W(1,6),W(1,8),W(1,3),GC_392,AMP(5))
      CALL FFV1_3PZ1_3(W(1,5),W(1,2),GC_288,-GC_252,MDL_MZ1, ZERO,W(1
     $ ,7))
C     Amplitude(s) for diagram number 6
      CALL VVS3_0(W(1,6),W(1,7),W(1,3),GC_397,AMP(6))
      CALL FFV1_3PZ1_3(W(1,1),W(1,4),GC_289,GC_252,MDL_MZ1, ZERO,W(1,6)
     $ )
C     Amplitude(s) for diagram number 7
      CALL VVS3_0(W(1,8),W(1,6),W(1,3),GC_397,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VVS3_0(W(1,6),W(1,7),W(1,3),GC_399,AMP(8))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.000000000000000D+00)*AMP(4)
      JAMP(2,1) = AMP(5)+AMP(6)+AMP(7)+AMP(8)
