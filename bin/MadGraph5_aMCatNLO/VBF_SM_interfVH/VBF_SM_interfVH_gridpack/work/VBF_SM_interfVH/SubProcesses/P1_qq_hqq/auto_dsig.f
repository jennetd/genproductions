...
C     
C     Process: u u > h u u QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c > h c c QCD=0 QED<=4 $ w+ w- z @1
C     Process: u d > h u d QCD=0 QED<=4 $ w+ w- z @1
C     Process: u u~ > h u u~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c~ > h c c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u u~ > h d d~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c~ > h s s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u d~ > h u d~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: c s~ > h c s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d > h d d QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s > h s s QCD=0 QED<=4 $ w+ w- z @1
C     Process: d u~ > h d u~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s c~ > h s c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d~ > h u u~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s~ > h c c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d~ > h d d~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s~ > h s s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s c > h s c QCD=0 QED<=4 $ w+ w- z @1
C     Process: u~ u~ > h u~ u~ QCD=0 QED<=4 $ w+ w- z @1
...
C     Process: s~ s~ > h s~ s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s~ c~ > h s~ c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u s > h u s QCD=0 QED<=4 $ w+ w- z @1
C     Process: u s > h d c QCD=0 QED<=4 $ w+ w- z @1
C     Process: d c > h u s QCD=0 QED<=4 $ w+ w- z @1
C     Process: u c > h u c QCD=0 QED<=4 $ w+ w- z @1
C     Process: u u~ > h s s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c~ > h d d~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u u~ > h c c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: c c~ > h u u~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u d~ > h c s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: d u~ > h s c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s c~ > h d u~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: c s~ > h u d~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u s~ > h u s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: c d~ > h c d~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u c~ > h u c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: c u~ > h c u~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u c~ > h d s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: d s~ > h u c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s d~ > h c u~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: c u~ > h s d~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: d s > h d s QCD=0 QED<=4 $ w+ w- z @1
C     Process: d c > h d c QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d~ > h s s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s~ > h d d~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: d d~ > h c c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s s~ > h u u~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: d s~ > h d s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s d~ > h s d~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: d c~ > h d c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: s u~ > h s u~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u~ s~ > h u~ s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u~ s~ > h d~ c~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: d~ c~ > h u~ s~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: u~ c~ > h u~ c~ QCD=0 QED<=4 $ w+ w- z @1
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        IF(IPROC.EQ.26) DSIGPROC=DSIG26(P1,WGT,IMODE)  ! d d~ > h s s~
        IF(IPROC.EQ.27) DSIGPROC=DSIG27(P1,WGT,IMODE)  ! d d~ > h c c~
        IF(IPROC.EQ.28) DSIGPROC=DSIG28(P1,WGT,IMODE)  ! d s~ > h d s~
        IF(IPROC.EQ.29) DSIGPROC=DSIG29(P1,WGT,IMODE)  ! d c~ > h d c~
        IF(IPROC.EQ.30) DSIGPROC=DSIG30(P1,WGT,IMODE)  ! u~ s~ > h u~ s~
        IF(IPROC.EQ.31) DSIGPROC=DSIG31(P1,WGT,IMODE)  ! u~ s~ > h d~ c~
        IF(IPROC.EQ.32) DSIGPROC=DSIG32(P1,WGT,IMODE)  ! u~ c~ > h u~ c~
        IF(IPROC.EQ.33) DSIGPROC=DSIG33(P1,WGT,IMODE)  ! d~ s~ > h d~ s~
        IF(IPROC.EQ.34) DSIGPROC=DSIG34(P1,WGT,IMODE)  ! d~ c~ > h d~ c~
      ENDIF
