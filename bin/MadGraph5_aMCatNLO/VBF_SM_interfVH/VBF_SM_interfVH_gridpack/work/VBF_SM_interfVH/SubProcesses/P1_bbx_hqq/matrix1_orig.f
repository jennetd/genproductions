...
C     
C     Process: b b~ > h u u~ QCD=0 QED<=4 $ w+ w- z @1
C     Process: b b~ > h c c~ QCD=0 QED<=4 $ w+ w- z @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_5_3(W(1,5),W(1,4),-GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,7)
     $ )
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,6),W(1,7),W(1,3),GC_81,AMP(1))
      CALL FFS4_2(W(1,1),W(1,3),GC_83,MDL_MB, FK_ZERO,W(1,6))
      CALL FFV1P0_3(W(1,5),W(1,4),GC_2,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_1,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,6),W(1,2),W(1,7),GC_50,GC_58,AMP(3))
      CALL FFS4_1(W(1,2),W(1,3),GC_83,MDL_MB, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,1),W(1,6),W(1,8),GC_1,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,1),W(1,6),W(1,7),GC_50,GC_58,AMP(5))
